...
## 라이센스
Kiwi는 Apache License 2.0 라이센스로 배포됩니다. 자세한 내용은 [LICENSE](LICENSE)를 참고해주세요.

학습된 모델 파일 또한 동일한 라이센스로 배포됩니다. 모델 학습에는 국립국어원의 21세기 세종계획 말뭉치와 모두의 말뭉치를 사용했으며, 원본 말뭉치 자체는 Kiwi와 함께 배포되지 않습니다. 자세한 내용은 [NOTICE](NOTICE)를 참고해주세요.

기존에 배포된 0.23.2 이하 버전은 LGPL 라이센스로 배포되었으며, 해당 버전에는 계속 LGPL이 적용됩니다. 
